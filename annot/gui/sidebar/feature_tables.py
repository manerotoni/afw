...
_Cecog = {"Intensity": ('n2_avg',
         ...
         "Haralick": ('h1_2ASM',
                      ...
                      'h8_average',
                      'h8_variance'),
         "Granulometry": ('granu_close_area_1',
                          'granu_close_area_2',
                          'granu_close_area_3',
                          'granu_close_area_5',
                          'granu_close_area_7',
         ...
         "Convexhull": ('ch_acd',
                        ...
                        'ch_thresh_cc',
                        'ch_variance_area'),
         "Distance Map": ('dyn_distance_nb_max',
...
_CecogSimple = {"Brightness": ("n2_avg", ),
               "Homogenity": ("n2_stddev", ),
               "Shape": ("eccentricity", ),
               "Texture": ("h4_ASM", "h8_2COR"),
               "Granularity": ('granu_close_volume_7', 'granu_open_volume_5')}


class FeatureTables(object):

    CecogSimple = _CecogSimple
    Cecog = _Cecog
...
if __name__ == "__main__":
    ...
    features = list()
    for values in CECOG.values():
        features.extend(values)

    print "Number of features", len(features)
    print "Number of features", len(set(features))
